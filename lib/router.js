...
router.get('/zju/cse/:type', require('./routes/universities/zju/cse'));
...
// labs
router.get('/lab/tumvision', require('./routes/lab/tumvision'));
router.get('/lab/tum-campar', require('./routes/lab/tum-campar'));
router.get('/lab/cmuri', require('./routes/lab/cmuri'));
router.get('/lab/ethz-v4rl', require('./routes/lab/ethz-v4rl'));
router.get('/lab/ethz-rpg', require('./routes/lab/ethz-rpg'));
router.get('/lab/ethz-asl', require('./routes/lab/ethz-asl'));
router.get('/lab/hkust-uav', require('./routes/lab/hkust-uav'));
router.get('/lab/mit-mcube', require('./routes/lab/mit-mcube'));
router.get('/lab/ox-ro', require('./routes/lab/ox-ro'));
router.get('/lab/wst-rse', require('./routes/lab/wst-rse'));
router.get('/lab/pn-kr', require('./routes/lab/pn-kr'));
