...
const host = 'https://vision.in.tum.de/publications';
...
module.exports = async (ctx) => {
    ...
    const list = $('.result').find('tr.bibline').slice(0, 20);
