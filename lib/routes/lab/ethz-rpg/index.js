...
const host = 'http://rpg.ifi.uzh.ch/publications.html';
const hostName = 'ethz-rpg';
// const map = new Map([
...
module.exports = async (ctx) => {
    ...
    const list = $('.publication-list').find('div').slice(0, 20);
        ...
        list
            .map((index, item) => {
                ...
                return {
                    ...
                    description: item.find('.img-wrapper').text(),
